...
const plans = [
    { title: '1 месяц', days: 30, price: Math.floor(261) },
    { title: '6 месяцев', days: 180, price: Math.floor(1125), profit: 30 },
    { title: '12 месяцев', days: 365, price: Math.floor(1649), profit: 50 },
]
