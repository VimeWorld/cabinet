...
const Row = ({ name, children }) => {
    return <div className="mb-3 d-flex justify-content-between border-bottom" style={{ minHeight: rowHeight }}>
...
const TransactionConfirmPage = () => {
    ...
    let content
    if (loading)
        content = <div className="text-center"><Spinner size="lg" variant="secondary" /></div>
    else if (error)
        content = <div className="text-danger text-center">{error}</div>
    else if (success)
        content = <>
    ...
    return <OuterPage>
        ...
        <div className="text-center mt-4">
            <Link to="/" className="me-2">Главная</Link>
