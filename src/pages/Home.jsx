...
const PersonalInfoCard = () => {
  ...
  if (regUnix) regTime = new Date(regUnix).toLocaleDateString();
  ...
  return (
    <div className="card">
      <div className="card-header">
        ...
        <span className="text-muted">Данные аккаунта</span>
      </div>
      <div className="card-body">
        <dl className="row mb-0">
          ...
          <dd className="col-sm-8" role="button" onClick={() => setEmailHidden(!emailHidden)}>
            {email}
          </dd>
