    ...
    <Nav>
      <NavDropdown
        ...
        {Object.entries(themes).map(([id, t]) => {
          ...
          if (!active) iconClass += ' opacity-50';
          return (
            <NavDropdown.Item
              key={id}
              onClick={() => {
                let savid = id;
                if (savid === 'auto') savid = null;
...
const MainNavbar = () => {
  return (
    <Navbar bg="body" expand="md" className="shadow-sm">
      <Container>
        <SidebarToggleButton />
        <Navbar.Brand href="https://vimeworld.com" className="p-0 me-0 me-md-4 fs-4 fw-bold">
          VimeWorld
        </Navbar.Brand>
        ...
        <Navbar.Offcanvas
          ...
          <Offcanvas.Header closeButton>
            <Offcanvas.Title id="main-nav-offcanvas-label">VimeWorld</Offcanvas.Title>
          </Offcanvas.Header>
          <Offcanvas.Body>
            <Nav className="flex-grow-1">
              <Nav.Link href="https://vimeworld.com">Сайт</Nav.Link>
              <Nav.Link href="https://forum.vimeworld.com">Форум</Nav.Link>
              <Nav.Link href="https://forum.vimeworld.com/forum/139-%D0%BD%D0%BE%D0%B2%D0%BE%D1%81%D1%82%D0%B8/">
                Новости
              </Nav.Link>
            </Nav>
