...
const SidebarToggleButton = () => {
  ...
  if (!exists) return <div className="d-md-none" style={{ width: '3rem' }}></div>;
...
const Sidebar = () => {
  ...
  return (
    <div className="bg-body rounded-3 shadow-sm p-4 mb-5 d-none d-md-block">
      <Offcanvas
        ...
        <Offcanvas.Header closeButton>
          <Offcanvas.Title id="sidebar-offcanvas-label">Личный кабинет</Offcanvas.Title>
        </Offcanvas.Header>
        <Offcanvas.Body>
          <div className="sidebar w-100">
            <div className="nav-header p-1 mb-1">Меню</div>
            <ul className="nav nav-pills flex-column mb-3">
              <MenuItem to="/" icon="bi-house-door">
                Главная
              </MenuItem>
              <MenuItem to="/payments" icon="bi-credit-card">
                Платежи
              </MenuItem>
              <MenuItem to="/security" icon="bi-shield">
                Безопасность
              </MenuItem>
              <MenuItem to="/bans" icon="bi-slash-circle">
                Баны
              </MenuItem>
            </ul>
            <div className="nav-header p-1 mb-1">Minigames</div>
            <ul className="nav nav-pills flex-column">
              <MenuItem to="/minigames/donate" icon="bi-cash-coin">
                Изменение статуса
              </MenuItem>
              <MenuItem to="/minigames/guild" icon="bi-people">
                Управление гильдией
              </MenuItem>
            </ul>
          </div>
