  ...
  return (
    <Modal show={show} onHide={close}>
      <form onSubmit={onSubmit}>
        ...
        <Modal.Body>
          <p>
            Скин должен быть в формате <code>.png</code>. Размеры скина должны быть{' '}
            <code>64x64</code> или <code>64х32</code>.
          </p>
          ...
          <div>
            ...
            <div className="form-check form-check-inline">
              ...
              <OverlayTrigger overlay={<Tooltip>Стандартный скин</Tooltip>}>
                <label className="form-check-label" htmlFor="check-steve">
                  Стив
                </label>
              </OverlayTrigger>
            </div>
            <div className="form-check form-check-inline">
              ...
              <OverlayTrigger overlay={<Tooltip>Более тонкие руки</Tooltip>}>
                <label className="form-check-label" htmlFor="check-alex">
                  Алекс
                </label>
              </OverlayTrigger>
            </div>
    ...
    <Modal show={show} onHide={close}>
      <form onSubmit={onSubmit}>
        ...
        <Modal.Body>
          {!exists && (
            <p>
              Стоимость плаща <b className="text-success">50 вимеров</b>. После покупки вы сможете
              менять плащ сколько угодно раз.
            </p>
          )}

          <p>
            Плащ должен быть в формате <code>.png</code>. Размеры плаща должны быть{' '}
            <code>22х17</code> или <code>64х32</code>.
          </p>
    ...
    <div className="card">
      <div className="card-header">
        ...
        <span className="text-muted">
          Здесь вы можете изменить свой скин на всех серверах VimeWorld
        </span>
      </div>
      <div ref={cardRef} className="card-body">
        <Suspense
          ...
          <SkinViewer3d
            ...
            cape={
              capeExists &&
              `https://mc.vimeworld.com/launcher/cloaks/${app.user.username}.png${anticache}`
            }
            height={250}
            parent={cardRef}
          />
        ...
        <div className="d-flex justify-content-center gap-3">
          <button className="btn btn-outline-primary" onClick={() => setShowModalSkin(true)}>
            Изменить скин
          </button>
        ...
        />
        <ModalSkin show={showModalSkin} close={() => setShowModalSkin(false)} />
      </div>
    </div>
  );
};
